...
/**
 * WebRTC Voice Chat Hook for Escape Room
 * Reuses the same signaling logic as Survival and Dark Room
 */
...
export function useVoiceChat(socket) {
    const [isVoiceActive, setIsVoiceActive] = useState(false);
    const [isMuted, setIsMuted] = useState(false);
    const [peers, setPeers] = useState({}); // { peerId: { connected, stream } }
    ...
    }, [isVoiceActive, createPeerConnection, cleanupPeer, socket]);
