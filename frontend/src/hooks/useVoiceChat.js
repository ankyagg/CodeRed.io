    ...
    const joinVoice = useCallback(async () => {
        try {
            ...
            if (!navigator.mediaDevices || !navigator.mediaDevices.getUserMedia) {
                throw new Error("Browser blocked microphone access. You must use HTTPS or localhost to use Voice Chat.");
            }
            ...
            setError(`Microphone access denied: ${err.message || err.name || 'Unknown'}`);
        }
    }, []);
